    ...
    <div class="container">
      ...
      <div class="checkout-addr">
        ...
        <div class="addr-list-wrap">
          ...
          <div class="addr-list">
            ...
            <ul>
              ...
              <li v-for="(address,index) in filterAddress" v-bind:class="{'check': index==curIndex}" v-on:click="curIndex=index">
                ...
                <div class="addr-opration addr-edit">
                  ...
                  <a href="javascript:;" class="addr-edit-btn" v-on:click="edit">
                ...
                <div class="addr-opration addr-del">
                  ...
                  <a href="javascript:;" class="addr-del-btn" v-on:click="delFlag=true">
          ...
          <div class="shipping-addr-more">
            ...
            <a class="addr-more-btn up-down-btn" href="javascript:" v-on:click="more">
        ...
        <div class="md-modal modal-msg md-modal-transition" id="showModalw" v-bind:class="{'md-show':editFlag}">
          ...
          <div class="md-modal-inner">
            <div class="md-top">
              <button class="md-close" v-on:click="editFlag=false">关闭</button>
            </div>
            <div class="md-content">
              <div class="confirm-tips">
              ...
              <div class="btn-wrap col-2">
                ...
                <button class="btn btn--s btn--red" id="btnModalCancels" v-on:click="editFlag=false">取消</button>
              </div>
            </div>
          </div>
        </div>
        <div class="md-overlay" v-if="delFlag || editFlag"></div>
      </div>
    </div>
  </div>
</template>
